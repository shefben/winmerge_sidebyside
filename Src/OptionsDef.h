...
inline const String OPT_DIRVIEW_SXS_THIN_GUTTER {_T("DirViewSxS/ThinGutter"s)};
inline const String OPT_DIRVIEW_SXS_INCLUDE_FILES {_T("DirViewSxS/IncludeFiles"s)};
inline const String OPT_DIRVIEW_SXS_EXCLUDE_FILES {_T("DirViewSxS/ExcludeFiles"s)};
inline const String OPT_DIRVIEW_SXS_INCLUDE_FOLDERS {_T("DirViewSxS/IncludeFolders"s)};
inline const String OPT_DIRVIEW_SXS_EXCLUDE_FOLDERS {_T("DirViewSxS/ExcludeFolders"s)};
inline const String OPT_DIRVIEW_SXS_LEFT_READONLY {_T("DirViewSxS/LeftReadOnly"s)};
inline const String OPT_DIRVIEW_SXS_RIGHT_READONLY {_T("DirViewSxS/RightReadOnly"s)};
inline const String OPT_DIRVIEW_SXS_DESCRIPTION {_T("DirViewSxS/Description"s)};
...
inline const String OPT_CMP_SXS_COMPARE_SIZE {_T("Settings/SxsCompareSize"s)};
inline const String OPT_CMP_SXS_COMPARE_TIMESTAMPS {_T("Settings/SxsCompareTimestamps"s)};
inline const String OPT_CMP_SXS_COMPARE_CONTENTS {_T("Settings/SxsCompareContents"s)};
inline const String OPT_CMP_SXS_CONTENTS_MODE {_T("Settings/SxsContentsMode"s)};
inline const String OPT_CMP_SXS_COMPARE_VERSIONS {_T("Settings/SxsCompareVersions"s)};
inline const String OPT_CMP_SXS_COMPARE_CASE {_T("Settings/SxsCompareCase"s)};
inline const String OPT_CMP_SXS_ARCHIVE_MODE {_T("Settings/SxsArchiveMode"s)};
inline const String OPT_CMP_SXS_EXPAND_ON_LOAD {_T("Settings/SxsExpandOnLoad"s)};
inline const String OPT_CMP_SXS_EXPAND_DIFFS_ONLY {_T("Settings/SxsExpandDiffsOnly"s)};
inline const String OPT_CMP_SXS_ATTR_ARCHIVE {_T("Settings/SxsAttrArchive"s)};
inline const String OPT_CMP_SXS_ATTR_SYSTEM {_T("Settings/SxsAttrSystem"s)};
inline const String OPT_CMP_SXS_ATTR_HIDDEN {_T("Settings/SxsAttrHidden"s)};
inline const String OPT_CMP_SXS_ATTR_READONLY {_T("Settings/SxsAttrReadOnly"s)};
inline const String OPT_CMP_SXS_ALIGN_DIFF_EXT {_T("Settings/SxsAlignDiffExt"s)};
inline const String OPT_CMP_SXS_ALIGN_UNICODE {_T("Settings/SxsAlignUnicode"s)};
inline const String OPT_CMP_SXS_SKIP_IF_QUICK_SAME {_T("Settings/SxsSkipIfQuickSame"s)};
inline const String OPT_CMP_SXS_OVERRIDE_QUICK {_T("Settings/SxsOverrideQuick"s)};
inline const String OPT_CMP_SXS_EXCLUDE_OS_FILES {_T("Settings/SxsExcludeOsFiles"s)};
...
inline const String OPT_CMP_TRUST_FILE_METADATA {_T("Settings/TrustFileMetadata"s)};
